...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppRefResource) DeepCopyInto(out *AppRefResource) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppRefResource.
func (in *AppRefResource) DeepCopy() *AppRefResource {
	if in == nil {
		return nil
	}
	out := new(AppRefResource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FusionAppInstanceSpec) DeepCopyInto(out *FusionAppInstanceSpec) {
	*out = *in
	...
	if in.RefResource != nil {
		...
		*out = make([]AppRefResource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
