...
import (
	v1alpha1 "github.com/fusion-app/fusion-app/pkg/client/clientset/versioned/typed/fusionapp/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeFusionappV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeFusionappV1alpha1) RESTClient() rest.Interface {
